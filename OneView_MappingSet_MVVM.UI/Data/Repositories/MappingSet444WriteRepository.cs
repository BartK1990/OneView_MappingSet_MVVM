...
{
    public class MappingSet444WriteRepository : ExcelRepository<MappingTagList, MappingSet444CreateExcelAccess>, IMappingSetWriteRepository
    {
        public MappingSet444WriteRepository(MappingSet444CreateExcelAccess excelAccess) : base(excelAccess)
        {
        }
