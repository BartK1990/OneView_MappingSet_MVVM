...
{
    public class MappingSet451CreateExcelAccess : ExcelAccessCreate<MappingTagList>
    {
        private static readonly List<MappingSetExcelColumn> MappingSetExcelColumns = new List<MappingSetExcelColumn>
        {
            ...
            ,{ new MappingSetExcelColumn(3, mappingTagPropertyName: "PresentationNameGerman", "Presentation Name\n(German)", "Green") }
            ,{ new MappingSetExcelColumn(4, mappingTagPropertyName: "PresentationNameSpanish", "Presentation Name\n(Spanish)", "Green") }
            ,{ new MappingSetExcelColumn(5, mappingTagPropertyName: "PresentationNamePolish", "Presentation Name\n(Polish)", "Green") }
